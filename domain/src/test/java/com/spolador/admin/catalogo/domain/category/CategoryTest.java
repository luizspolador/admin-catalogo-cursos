...
public class CategoryTest {
    ...
    public void givenAValidParams_whenCallNewCategory_thenInstantiateACategory() {
        ...
        final var expectedDescription = "Categorias mais assistidas";
    ...
    @Test
    public void givenAnInvalidNameLengthGreaterOrMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        final String expectedName = """
    ...
    public void givenAValidCategory_whenCallUpdate_thenReturnCategoryUpdated() {
        ...
        final var aCategory =
                Category.newCategory("Frontend", "A categoria", expectedIsActive);
    ...
    public void givenAValidCategory_whenCallUpdateToInactive_thenReturnCategoryUpdated() {
        ...
        final var aCategory =
                Category.newCategory("Frontend", "A categoria", true);
